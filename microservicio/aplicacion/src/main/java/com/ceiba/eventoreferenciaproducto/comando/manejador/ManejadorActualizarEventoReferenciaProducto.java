...
@Component
public class ManejadorActualizarEventoReferenciaProducto implements ManejadorComando<ComandoEvento> {

    private final FabricaEvento fabricaEvento;
    private final ServicioActualizarEvento servicioActualizarEvento;

    public ManejadorActualizarEventoReferenciaProducto(FabricaEvento fabricaEvento, ServicioActualizarEvento servicioActualizarEvento) {
