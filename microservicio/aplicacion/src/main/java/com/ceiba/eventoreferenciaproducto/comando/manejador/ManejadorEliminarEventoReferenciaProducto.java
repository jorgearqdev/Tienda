...
@Component
public class ManejadorEliminarEventoReferenciaProducto implements ManejadorComando<ComandoEventoActualizar> {

	private final ServicioSwitchEvento servicioSwitchEvento;
	private final FabricaEventoActualizar fabricaEventoActualizar;

	public ManejadorEliminarEventoReferenciaProducto(FabricaEventoActualizar fabricaEventoActualizar,
